...
var Verified = map[string]override{
	...
	"developpp-ventures":        {0, "", "15 Nov 2026 is call OPENING; startup must be registered in CI/GH/NG/ZA/KE/TZ/RW", "Ineligible (CAR/Chad not listed)."},
	"climate-change-ai":         {0, "", "invitation-only 2025; PI at OECD university required", "Ineligible."},
	"digital-africa-fuze":       {0, "", "African-incorporated startups only", "Ineligible without African entity."},
